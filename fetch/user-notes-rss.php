...
>
  ...
  <items>
    <?php if ($notes) { ?>
    <rdf:Seq>
      <rdf:li rdf:resource="http://master.php.net/note/edit/<?php
      echo implode('"/> <rdf:li rdf:resource="http://master.php.net/note/edit/',
        array_keys($notes));?>"/>
    </rdf:Seq>
    <?php } ?>
  </items>
...
foreach ($notes as $note) {
  ...
  <item>
    ...
    <link>http://master.php.net/note/edit/<?php echo $note['id']; ?></link>
    <description>
      <![CDATA[

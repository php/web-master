...
>
  ...
  <link>https://master2.php.net/manage/user-notes.php</link>
  <description/>
  <items>
    <?php if ($notes) { ?>
    <rdf:Seq>
      <rdf:li rdf:resource="https://master2.php.net/note/edit/<?php
      echo implode('"/> <rdf:li rdf:resource="https://master2.php.net/note/edit/',
        array_keys($notes));?>"/>
    </rdf:Seq>
    <?php } ?>
  </items>
...
foreach ($notes as $note) {
  ...
  <item>
    ...
    <link>https://master2.php.net/note/edit/<?php echo $note['id']; ?></link>
    <description>
      <![CDATA[
